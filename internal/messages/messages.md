...
Это один ежедневный список. Каждый пункт — с новой строки через дефис:
...
Каждый пункт должен начинаться с дефиса.
...
Карточка придет сегодня после 20:00, если список сохранен до этого времени.
...
## routine.reminder
🔔 <b>Рутина за {{date}} еще не закрыта</b>
Закрой ее до 12:00, иначе неотмеченные пункты будут засчитаны как невыполненные.

## routine.auto_closed
⏰ <b>Время вышло</b>
Рутина за {{date}} закрыта автоматически: неотмеченные пункты засчитаны как невыполненные.

## routine.auto_closed.notice
