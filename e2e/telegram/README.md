...
- недельный обзор и итог периода по целям идут в теме `Цели`;
...
- `12-routine-checkin.jsonl.tmpl`: настройка рутины и ежедневная проверка в `Рутины`.
- `13-goals-weekly-final.jsonl.tmpl`: настройка сезонных целей, недельный обзор и
  итог периода в `Цели`.
